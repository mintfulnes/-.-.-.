...
export const ARTWORKS: Record<ArtworkId, Artwork> = {
  proverbs: {
    ...
    imageSrc: '/media/proverbs.jpg',
    videoSrc: '/media/proverbs.mp4',
    fallbackImage:
  ...
  haywain: {
    ...
    imageSrc: '/media/haywain.jpg',
    videoSrc: '/media/haywain.mp4',
    fallbackImage:
  ...
  anatomy: {
    ...
    imageSrc: '/media/anatomy.jpg',
    videoSrc: '/media/anatomy.mp4',
    fallbackImage:
  ...
  sea: {
    ...
    imageSrc: '/media/sea.jpg',
    videoSrc: '/media/sea.mp4',
    fallbackImage:
