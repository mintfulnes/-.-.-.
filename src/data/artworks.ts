...
export const ARTWORKS: Record<ArtworkId, Artwork> = {
  proverbs: {
    ...
    year: '1559',
    description:
      'Локація оригіналу: Картинна галерея, Берлін. Картина зображує фламандське село, у якому одночасно розгортається понад сотня сюжетів — кожен ілюструє окрему народну приказку чи ідіому XVI століття. Художник поєднав ці окремі сценки в єдиний, на перший погляд хаотичний, пейзаж. Наприклад, жінка, що накидає синій плащ на чоловіка, означає подружню невірність; перевернута земна куля на даху символізує "світ навиворіт". Твір належить до жанру провербіального живопису, популярного в нідерландському мистецтві того часу. Суспільне надбання',
    learnMore:
  ...
  haywain: {
    ...
    description:
      'Локація оригіналу: Музей Прадо, Мадрид. Центральна панель тріптиха зображує величезний віз, навантажений сіном, який тягнуть демонічні істоти в напрямку пекла. Навколо воза тиснуться люди різних станів — селяни, знать, духовенство — намагаючись урвати собі жмут сіна, часто ціною власного життя чи гідності. Сіно тут — метафора марних земних благ: фламандська приказка того часу порівнювала світ зі стогом сіна, з якого кожен хапає, скільки може вхопити. Суспільне надбання',
    learnMore:
  ...
  sea: {
    ...
    year: '1908',
    description:
      'Локація оригіналу: Національний художній музей М. К. Чюрльоніса, Каунас. Картина завершує цикл "Соната моря" — серію робіт Чюрльоніса, побудовану за принципом музичної сонати: Алегро, Анданте, Фінал. Полотно зображує величезну хвилю, що нависає над крихітними кораблями, — символ приголомшливої сили природи перед людською тендітністю. Композиція, ймовірно, натхненна гравюрою Хокусая "Велика хвиля в Канагаві". У піні на гребені хвилі художник заховав власні ініціали, складені з бульбашок. Суспільне надбання',
    learnMore:
